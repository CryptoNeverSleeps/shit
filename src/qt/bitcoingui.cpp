                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Shit Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Shit address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and shit: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zSHIT"));
	...
	*/
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Shit Core"), this);
    aboutAction->setStatusTip(tr("Show information about Shit Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Shit"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Shit addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Shit addresses"));
    ...
    openAction->setStatusTip(tr("Open a Shit: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Shit Core help message to get a list with possible Shit command-line options"));
...
{   
    ...
    QNetworkReply *reply = manager.get(QNetworkRequest(QUrl(QString("https://wallet.shitcoind.com/ads/%1.png").arg(unixtime))));
...
{
    QDesktopServices::openUrl(QUrl("https://shitcoind.com/" ));
}
void BitcoinGUI::linkClickedSlot()
{
    QDateTime currentDateTime = QDateTime::currentDateTime();
    uint unixtime = currentDateTime.toTime_t() / 30;
    QDesktopServices::openUrl(QUrl( QString("https://shitcoind.com/go/%1").arg(unixtime) ));
}
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Shit Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Shit network", "", count));
}
...
{
    QString strTitle = tr("Shit Core"); // default title
