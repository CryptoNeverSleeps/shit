/* src/config/shit-config.h.  Generated from shit-config.h.in by configure.  */
/* src/config/shit-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef SHIT_CONFIG_H

#define SHIT_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.shitcoind.com"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Shit Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Shit Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "shit"
