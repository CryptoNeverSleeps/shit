...
public:
    CMainParams()
    {
        ...
        vSeeds.push_back(CDNSSeedData("clubs.seed.shitcoind.com", "clubs.seed.shitcoind.com"));
        vSeeds.push_back(CDNSSeedData("hearts.seed.shitcoind.com", "hearts.seed.shitcoind.com"));
        vSeeds.push_back(CDNSSeedData("diamonds.seed.shitcoind.com", "diamonds.seed.shitcoind.com"));
        vSeeds.push_back(CDNSSeedData("spades.seed.shitcoind.com", "spades.seed.shitcoind.com"));
